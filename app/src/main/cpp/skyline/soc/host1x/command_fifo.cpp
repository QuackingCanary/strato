...
namespace skyline::soc::host1x {
    ...
    ChannelCommandFifo::ChannelCommandFifo(const DeviceState &state, SyncpointSet &syncpoints, NvDecDevice &nvDec, VicDevice &vic) : state(state), gatherQueue(GatherQueueSize), host1XClass(syncpoints), nvDecClass(syncpoints, nvDec), vicClass(syncpoints, vic) {}
